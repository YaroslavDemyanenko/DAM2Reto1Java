...
public class PanelMenuDpto extends JPanel {
	...
	public JButton btnIngresarDepartamento, btnSiguiente, btnUltimo, btnAnterior, btnPrimero;
	...
	private void setParametros() {
		...
		btnIngresarDepartamento = new JButton("INGRESAR NUEVO DEPARTAMENTO");
		btnIngresarDepartamento.setBounds(393, 156, 226, 23);
		add(btnIngresarDepartamento);
